...
export class NotificationsService {
  ...
  notifyEoiApproved(email: string) {
    void this.send(
      email,
      'Your Expression of Interest has been approved',
      'Your organization\'s Expression of Interest has been approved. Sign in with this email (via OTP, no password needed) to access your employer dashboard.',
    );
  }

  notifyEoiRejected(email: string) {
    void this.send(
      email,
      'Update on your Expression of Interest',
      'Your Expression of Interest was not approved at this time.',
    );
  }
}
