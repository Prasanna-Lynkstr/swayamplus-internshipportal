...
export class QueryInternshipsDto {
  ...
  @IsOptional()
  @Transform(toArray)
  @IsIn(['UG', 'PG', 'Other', 'Any'], { each: true })
  ...
  // A single "at least ₹X/month" floor, not a min/max band — nobody filters
  // out a *higher*-paying internship, so this is the one threshold the
  // frontend's preset chips (Any/₹2,000+/₹5,000+/₹10,000+/₹15,000+) send.
  @IsOptional()
  @Type(() => Number)
  @IsInt()
  @Min(0)
