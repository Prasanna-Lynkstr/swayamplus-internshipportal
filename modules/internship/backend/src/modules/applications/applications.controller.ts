...
export class ApplicationsController {
  ...
  apply(
    @Param('id', ParseUUIDPipe) internshipUuid: string,
    @CurrentUser() user: AuthenticatedUser,
    @Body() dto: ApplyDto,
  ) {
    return this.applicationsService.apply(user.sub, internshipUuid, dto);
  }
  ...
  findMyApplication(
    ...
    return this.applicationsService.findMyApplicationForInternship(user.sub, internshipUuid);
  }
  ...
  findForInternship(
    ...
    return this.applicationsService.findForInternship(internshipUuid, user.sub, query);
  }
