      ...
      include: [
        {
          ...
          as: 'student',
          include: [
            // Never include the full User model without excluding
            // passwordHash — the one field that must never leave the process.
            { model: this.userModel, as: 'user', attributes: { exclude: ['passwordHash'] } },
          ],
        },
      ],
